...
func (c *Context) Session(ctx context.Context, id uint64, opts *options.QueryOptions) (res *v3.Session, err error) {
...
func (c *Context) Sessions(ctx context.Context, opts *options.QueryOptions) (res []v3.Session, err error) {
	// Initialize variables for the query.
	var (
...
// The result is a slice of v3.Session and an error if the query fails.
func (c *Context) SessionsForAccount(ctx context.Context, accAddr cosmossdk.AccAddress, opts *options.QueryOptions) (res []v3.Session, err error) {
	// Initialize variables for the query.
	var (
...
// The result is a slice of v3.Session and an error if the query fails.
func (c *Context) SessionsForNode(ctx context.Context, nodeAddr base.NodeAddress, opts *options.QueryOptions) (res []v3.Session, err error) {
	// Initialize variables for the query.
	var (
...
// The result is a slice of v3.Session and an error if the query fails.
func (c *Context) SessionsForSubscription(ctx context.Context, id uint64, opts *options.QueryOptions) (res []v3.Session, err error) {
	// Initialize variables for the query.
	var (
...
// The result is a slice of v3.Session and an error if the query fails.
func (c *Context) SessionsForSubscriptionAllocation(ctx context.Context, id uint64, accAddr cosmossdk.AccAddress, opts *options.QueryOptions) (res []v3.Session, err error) {
	// Initialize variables for the query.
	var (
