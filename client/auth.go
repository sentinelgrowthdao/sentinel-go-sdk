...
func (c *Client) Account(ctx context.Context, accAddr cosmossdk.AccAddress, opts *options.QueryOptions) (res authtypes.AccountI, err error) {
...
func (c *Client) Accounts(ctx context.Context, opts *options.QueryOptions) (res []authtypes.AccountI, err error) {
	// Initialize variables for the query.
	var (
