...
func (c *Client) Lease(ctx context.Context, id uint64, opts *options.QueryOptions) (res *v1.Lease, err error) {
...
func (c *Client) Leases(ctx context.Context, opts *options.QueryOptions) (res []v1.Lease, err error) {
	// Initialize variables for the query.
	var (
...
func (c *Client) LeasesForNode(ctx context.Context, nodeAddr base.NodeAddress, opts *options.QueryOptions) (res []v1.Lease, err error) {
	// Initialize variables for the query.
	var (
...
func (c *Client) LeasesForProvider(ctx context.Context, provAddr base.ProvAddress, opts *options.QueryOptions) (res []v1.Lease, err error) {
	// Initialize variables for the query.
	var (
