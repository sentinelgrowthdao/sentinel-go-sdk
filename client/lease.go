...
func (c *Context) Lease(ctx context.Context, id uint64, opts *options.QueryOptions) (res *v1.Lease, err error) {
...
func (c *Context) Leases(ctx context.Context, opts *options.QueryOptions) (res []v1.Lease, err error) {
	// Initialize variables for the query.
	var (
...
func (c *Context) LeasesForNode(ctx context.Context, nodeAddr base.NodeAddress, opts *options.QueryOptions) (res []v1.Lease, err error) {
	// Initialize variables for the query.
	var (
...
func (c *Context) LeasesForProvider(ctx context.Context, provAddr base.ProvAddress, opts *options.QueryOptions) (res []v1.Lease, err error) {
	// Initialize variables for the query.
	var (
